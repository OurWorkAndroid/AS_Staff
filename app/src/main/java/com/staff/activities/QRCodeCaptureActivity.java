...
import com.staff.modules.zxing.LuminanceSource.RGBLuminanceSource;
import com.staff.modules.zxing.camera.CameraManager;
import com.staff.modules.zxing.control.AmbientLightManager;
import com.staff.modules.zxing.control.BeepManager;
import com.staff.modules.zxing.decode.CaptureActivityHandler;
import com.staff.modules.zxing.decode.FinishListener;
import com.staff.modules.zxing.decode.InactivityTimer;
import com.staff.modules.zxing.view.ViewfinderView;
import com.staff.utils.CommonUtils;
import com.staff.utils.ImageUtils;
import com.staff.utils.QQUtil;
...
public final class QRCodeCaptureActivity extends BaseActivity implements SurfaceHolder.Callback {
	...
	public void onCreate(Bundle icicle) {
		...
		Bitmap bm = ImageUtils.rotateBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.icon_nav_more_white), 90);
